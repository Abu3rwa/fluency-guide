    ...
    <Container maxWidth="lg">
      ...
      <Grid container spacing={{ xs: 2, sm: 3, md: 4 }} alignItems="stretch">
        {[
          ...
          {
            icon: <HeadsetMicIcon color="primary" sx={{ fontSize: 48 }} />,
          ...
          {
            icon: <PsychologyIcon color="primary" sx={{ fontSize: 48 }} />,
            title: t("landing.features.items.smartLearning.title"),
            description: t("landing.features.items.smartLearning.description"),
          },
        ].map((feature, index) => (
          <Grid
            item
